...
INSTALLED_APPS = [
    ...
    'corsheaders',
    # Note: Celery apps disabled for demo
    # 'django_celery_beat',
...
# Database
# Using SQLite for demo - switch to PostgreSQL in production
DATABASES = {
    'default': {
...
#         default=config('DATABASE_URL', default='postgresql://financeflow_user:password@localhost:5432/financeflow_db'),
#         conn_max_age=600
#     )
# }
